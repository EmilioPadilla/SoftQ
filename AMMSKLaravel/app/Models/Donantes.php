...
class Donantes extends Model
{
    ...
    protected $fillable = ['idRecurrencia','idTipoDonante','nombreCompleto1', 'fechaCumpleaños1','RFC1','correo1','telefono1','celular1','RazonSocial2','calle2','noInterior2','noExterior2','codigoPostal2','colonia2',
